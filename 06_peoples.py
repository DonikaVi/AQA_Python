...
#  advice: female and male calculation can be done vs
 flat list, or you can find your own approach ;)
...
sep_num = 25
print('-' * sep_num)
print(f"| {'Sex':^10} | {'Count':^9} |")
print('-' * sep_num)

flat_list = [item for t in people_new_list for item in t]
female = flat_list.count('female')
male = flat_list.count('male')

print(f"| {'Female':^9}  | {female:^10}| " '\n'
      f"| {'Male':^10} | {male:^9} | ")
print('-' * sep_num)
